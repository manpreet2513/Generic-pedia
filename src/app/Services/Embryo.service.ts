...
export class EmbryoService {
   ...
   // public setCartItemDefaultValue(setCartItemDefaultValue): void {
   //    let products: any;
   //    products = JSON.parse(localStorage.getItem('cart_item')) || [];
   //    const found = products.some(function(el, index): boolean {
    ...
    */
   public getAboutInfo() {
     let about_info: any = this.db.object('about_info');
     return about_info;
   }
